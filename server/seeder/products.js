...
The superfast chip powers advanced features like computational photography, fluid Dynamic Island transitions, and Voice Isolation for phone calls. And A16 Bionic is incredibly efficient to help deliver great all-day battery life.\n
  ...
  },
  {
    ...
    How to Finish Everything You Start is just the book you need to get more done! This book will help you in understanding the causes of the “unfinished” epidemic, its cures, and when choosing not to finish something is okay. By focusing on this one key issue that is sabotaging so many today in their quest to be more productive at work, and to have a more satisfying personal life.\n\n
    ...
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/author1.jpg" }],
    attrs: [
  ...
  {
    name: "Samay Hee Aapke Jeevan Ki Punji Hai",
    description: `‘डॉ. जैन येगर ने फिर यह कर दिखाया है! उनकी इस नई पुस्तक में कई आधुनिक, व्यावहारिक तथा प्रेरणादायक अवधारणाएँ, परामर्श तथा रणनीतियाँ दी गई हैं ताकि समय का प्रबंधन किया जा सके और जीवन में वह सब कुछ पाया जा सके जो आप पाना चाहते हैं।’ - डॉन गेबर, हाउ टु स्टार्ट अ कन्वर्सेशन ऐंड मेक फ्रेंड्स हम मोबाइल से पैदा होने वाले तनाव के युग में रह रहे हैं। एक दूसरे तक आसानी से जिस पहुँच का आनंद हम ले रहे हैं वह चुनौतियों से रहित नहीं है। सेल फ़ोन, टेब्लेट, कंप्यूटर तथा इंटरनेट के ज़रिए 24/7 संचार के कारण हम पूरे समय तनाव में रहते हैं और इसके अलावा हमारी निजता का हनन भी हो रहा है। इस पुस्तक में मशहूर लेखिका तथा बिज़नेस, उत्पादकता और संबंध विशेषज्ञ डॉ. जैन येगर ने इस नए माहौल में हमारे समय के श्रेष्ठ उपयोग के सटीक और आज़माए हुए तरीके प्रस्तुत किए हैं। वे बताती हैं कि कैसे हम अपने लक्ष्यों की प्राथमिकता तय करें तथा हमें जोड़े रखने वाले माहौल में और अधिक सक्षम कैसे बनें। भले ही आप ज़बर्दस्त दवाब झेल रहे एग्ज़ीक्यूटिव, उद्यमी, छात्र या गृहिणी हों, डॉ. जैन की यह सूचनाप्रद पुस्तक एक बेहतर रूप से संगठित तथा सफल जीवन के लिए बतौर गाइड आपके लिए ज़रूरी साबित हो सकती है।`,
    count: 60,
    price: 220,
    category: "Books",
    sales: 55,
    images: [
      { path: "/images/products/books/author2_1.jpg" },
      { path: "/images/products/books/author2_2.jpg" },
    ],
    attrs: [
      { key: "Author", value: "Jan Yager" },
  ...
  {
    name: "AVENGERS PAPERBACK 10 - DIE TODESJÄGER (German Edition) ",
    description: `Die multiversellen Masters of Evil sind die krassesten und schrecklichsten Schurken im gesamten Kosmos – und nun greifen sie Asgard sowie New York in der Marvel-Hauptrealität an! Können Iron Man, Captain America, Black Panther, Captain Marvel und Co. sie stoppen? Plus: Ein neues Abenteuer mit den Steinzeit-Avengers, das endlich klärt, welche Rolle der Phoenix bei der Geburt von Thor gespielt hat.`,
    count: 60,
    price: 1800,
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/author7.jpg" }],
    attrs: [
      { key: "Author", value: "Darick Robertson" },
      { key: "Format", value: "Kindle Edition" },
      { key: "Foreign Languages", value: "German" },
      { key: "Item Condition", value: "New" },
      { key: "Seller", value: "Browsers' Lounge" },
    ],
    rating: 4,
  ...
  {
    name: "PUNISHER 2, MÖRDERISCHE GÖTTER (German Edition) ",
    description: `Die große Punisher-Neudefinition! Frank Castle brachte viele Verbrecher zur Strecke. Nun ist der König der Killer Anführer der Hand. Die mystischen Ninja gaben Frank seine tote Frau zurück, und dafür führt er sie als Messias in die Zukunft! Doch Kriegsgott Ares und Daredevil wollen ihn stoppen.`,
    count: 60,
    price: 1225,
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/author8.jpg" }],
    attrs: [
      { key: "Author", value: "Darick Robertson" },
      { key: "Format", value: "Kindle Edition" },
      { key: "Foreign Languages", value: "German" },
  ...
  {
    name: "KÖNIG CONAN (German Edition)",
    description: `Conan ist der König von Aquilonia – und hat einen Sohn namens Conn. Doch während einer Reise erleidet der Cimmerier Schiffbruch auf einer verfluchten Insel. Hier trifft der bärtige König seinen Erzfeind, den bösen Zauberer Toth-Amon! Während Barbar und Magier einander bekämpfen, wird ihnen klar, dass auf dem Eiland noch mehr Gefahren und Gegner lauern.
    `,
    count: 60,
    price: 1325,
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/author9.jpg" }],
    attrs: [
      { key: "Author", value: "Darick Robertson" },
      { key: "Format", value: "Kindle Edition" },
      { key: "Foreign Languages", value: "German" },
  ...
  {
    name: "Harry Potter y la cámara secreta (Spanish Edition)",
    description: `Hay una conspiración, Harry Potter. Una conspiración para hacer que este año sucedan las cosas más terribles en el Colegio Hogwarts de Magia y Hechicería.\n\n
    ...
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/author10.jpg" }],
    attrs: [
      { key: "Author", value: "J.K. Rowling" },
      { key: "Format", value: "Kindle Edition" },
      { key: "Foreign Languages", value: "Spanish" },
      { key: "Item Condition", value: "New" },
      { key: "Seller", value: "uRead-Store" },
    ],
    rating: 4,
  ...
  {
    name: "Harry Potter y el legado maldito / Harry Potter and the Cursed Child",
    description: `Harry Potter y el legado maldito es una obra de teatro de Jack Thorne basada en una historia original de J.K. Rowling, John Tiffany y Jack Thorne. Es la octava historia de la saga de Harry Potter y la primera que se representa oficialmente en los escenarios.\n
    ...
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/author11.jpg" }],
    attrs: [
      { key: "Author", value: "J.K. Rowling" },
      { key: "Format", value: "Audiobook" },
      { key: "Foreign Languages", value: "Spanish" },
  ...
  {
    name: "kyuketsuki no shihai (Japanese Edition)",
    description: `『吸血鬼の支配 (‘The Ascent of the Vampires’)』は、英語学習者向けに特別に書かれた短編小説シリーズです。　理解しやすい英語で書かれており、各章末には日本語解説付きの語彙・慣用表現の索引もあります。　『多読』プログラムを実践している学生にも適しています。\n
    第一巻は、ある恐ろしい夜、どのようにして吸血鬼たちが世界を支配するのか、というストーリーです。　邪悪な吸血鬼たちが、人間たちを征服し奴隷にするための準備をしながら、何世紀にもの間、闇に潜んでいたのでした。　ごく普通の３人のティーンがその夜からどのようにして生還するのかが描かれています。　ハラハラするアクションシーンや恐怖の描写、そしてラブストーリーもあります。　各章はハラハラした緊張感が持続したままストーリーが終わるので、途中でやめられない、読み出したら止まらない！\n
    英語学習は退屈かもしれません。　でも『吸血鬼の支配　( ‘The Ascent of the Vampires’)』があればきっと 楽しめます！　さあ、今すぐダウンロードしよう！`,
    count: 60,
    price: 145,
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/author12.jpg" }],
    attrs: [
      { key: "Author", value: "Stephen R. Covey" },
      { key: "Format", value: "Paperback" },
      { key: "Foreign Languages", value: "Japanese" },
      { key: "Item Condition", value: "New" },
      { key: "Seller", value: "Cocoblu Retail" },
    ],
    rating: 4,
  ...
  {
    name: "101 Eigo wo Manabutameno Muryo Uebu-saito (Japanese Edition)",
    description: `国際化と求人市場のさらなる競争化に伴い、英語を学ぶことは今まで以上に重要になっています。\n
    以前は、英語を学ぶこととは高額なレッスン料を支払うことを意味していました。　しかし今日、英語を学ぶための素晴らしいウェブサイトが何百もあり、そのうちの多くが完全無料であることを、多くの学習者は知らないのです！\n
    あいにく、それら全てを検索することは多大な時間を費やすことになりますし、知名度の低い素晴らしいウェブサイトを見逃してしまいがちです。
    こちらにリストした簡単な情報は、この問題を解決することを目的にしています。　ここに英語を学ぶのに最適な無料ウェブサイトへのリンクを101集めました。
    分かりやすいように、次の見出しで項目ごとにウェブサイトが配列されています：文法、ボキャブラリー、発音、スピーキング、リスニング、リーディング、読解、ライティング、一般的英語学習、英語のネイティブスピーカーによる面白いウェブサイトコレクション。\n
    各ウェブサイトのリンクは有効ですので、デバイスが許可しさえすれば、この電子書籍から直接つながります（もしも許可されない場合は、パソコンのアドレスバーにリンクを入力すればいいだけです）。\n
    この本で、あなたは英語の上達をしながら、時間とお金も節約できますよ。`,
    count: 60,
    price: 225,
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/author13.jpg" }],
    attrs: [
      { key: "Author", value: "Stephen R. Covey" },
      { key: "Format", value: "Paperback" },
      { key: "Foreign Languages", value: "Japanese" },
  ...
  {
    name: "101 Eigo wo Manabutameno Muryo Uebu-saito (Japanese Edition)",
    description: `『7つの習慣』の著者コヴィー博士の息子ショーンが、全米中の若者が7つの習慣をどう取り入れ、どう変化をしていったかを、語りかけるような文体で書き起こした全世界500万部突破の『7つの習慣　ティーンズ』。2002年に出版した本書を、インターネット、SNSなどに代表されるデジタル時代のティーンに向けて、リニューアルしました。 『7つの習慣』は、これからの世界を担う、10代の子どもたちにこそ身につけてほしい習慣です。また、子どもたちを含め、ご家族で実践いただくことができれば、それぞれが自立し、そしてシナジーを発揮することで、すばらしい家族を築くことができるでしょう。`,
    count: 60,
    price: 500,
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/author15.jpg" }],
    attrs: [
      { key: "Author", value: "Stephen R. Covey" },
      { key: "Format", value: "Paperback" },
      { key: "Foreign Languages", value: "Japanese" },
  ...
  {
    name: "The Psychology of Money (Marathi Edition)",
  ...
  {
    name: "The 5 AM Club (Marathi Edition)",
    ...
    Now, in this lifechanging book, handcrafted by the author over a rigorous four year period, you will discover the earlyrising habit that has helped so many accomplish epic results while upgrading their happiness, helpfulness and feelings of aliveness.\n\n
    
    Through an enchanting—and often amusing—story about two struggling strangers who meet an eccentric tycoon who becomes their secret mentor.
    ROBIN SHARMA is a globally respected humanitarian. Widely considered one of the world’s top leadership and personal optimization advisors, his clients include famed billionaires, professional sports superstars and many Fortune 100 companies. The author’s #1 bestsellers, such as The Monk Who Sold His Ferrari, The Greatness Guide and The Leader Who Had No Title are in over 92 languages, making him one of the most broadly read writers alive today. A portion of the proceeds of this book will go to The Robin Sharma Foundation for Children to help kids in need live better lives.
    `,
    count: 60,
    price: 225,
    category: "Books",
  ...
  {
    name: "அந்தி மழை நேரத்தில் அவளோடு நான் !!! (Tamil Edition)",
    description: `அந்தி மழை நேரத்தில் அவளோடு நான்இது உன் குழந்தை தான் அப்படின்னு உனக்கு எப்படி தெரியும் அவ்ளோ நம்பிக்கையா இது உன் குழந்தைங்க தான்னு இவங்களை பெத்த நான் சொல்றேன் இல்லைன்னு என்று தெரிக்கும் விழிகளில் அவள் அவனை பார்த்து கேட்டாள்விட்டால் அவனை கண்களாலேயே பொசுக்கி இருப்பாள் போல அந்த அளவுக்கு அவளுக்கு அவன் மீது கோபமும் இருந்தது அதே அளவு பகையும் இருந்தது இத்தனை வருடம் விட்டு போனவன் இப்போது வந்து குழந்தை, ஆட்டுகுட்டி என கூறினால் அதை கேட்டு கொண்டிருக்க அவள் ஒன்னும் அவன் முன்பு பார்த்த அவள் இல்லை இப்போது எவ்வளவோ மாறி இருக்கிறாள்அப்படி இருக்க அவனை பார்த்து கேட்கவும் அதே ஆத்திரத்தோடு அனல் தெறிக்க ஒன்னு விட்டேன்னு வை என்றவன் அவள் பேசிய பேச்சு அவனுக்கு அவ்வளவு ஆத்திரத்தை கொடுக்க அவன் கையை ஓங்கினான்...அடித்து விடுவானோ என எண்ணி அவள் ஒரு அடி நகர எனக்கு இவங்க இரண்டு பேரும் என் குழந்தைங்க தான் அப்படின்னு நம்பிக்கை எனக்கு இருக்கு உனக்கு இல்லன்னா நான் இவங்களை கொண்டு போறேன் நீ இதோ இவன் கூட இரு அவனும் ரெடியா இருக்கான் உன்னை கட்டிக்க என அருகே நிற்கும் அவனை கை காட்ட அதை பார்த்த அவளோ அதிர அதை கண்ட அவன் தன் நெற்றி பொட்டை நீவியபடி அவளை அதே நக்கல் பார்வையோடு பார்த்தான்அவன் வாயில் நல்ல சொற்கள் வந்து அவள் பார்த்ததே இல்லை இப்போதும் அவன் அப்படி தான் இருக்கிறான் என்பதை அவளுக்கு பறைசாற்றும் விதமாக அவளை மேலும் கீழுமாக பார்த்தவன் ஏன் டி ஒரே ஷாட்ல இரண்டு குழந்தையை உனக்கு கொடுத்து இருக்கேன் எனக்கு தெரியாதா இது யார் குழந்தைன்னு என அவன் கேட்கவும் அவள் முகம் அன்றைய விசயங்களை நினைவு கூர்ந்து அவள் முகம் ரத்தமென சிவந்ததுசீ உனக்கு வெட்கமாக இல்லை இப்படி பேச என்றாள் அவஅவனோ நான் அன்னிக்கு வெட்கப்பட்டு இருந்தேன்னா நீ இப்படி என்கிட்ட பேசிட்டு இருக்க மாட்ட ஐ திங்க் நீ தான் அன்னிக்கு வெட்கப்பட்ட இல்லையா என அன்றைய நாளை நினைத்து அவன் நாராசமாக பேச துவங்கவும் இவனிடம் பேசி ஜெயிக்க முடியாது என்பது போல காதை பொத்தி கொள்ள அவனோ நக்கலாக அவளை பார்த்து சிரித்தான்`,
    count: 60,
    price: 250,
    category: "Books",
    sales: 55,
  ...
  {
    name: "காத்திருந்த கல்லூரி காதல்!!!!! (Tamil Edition)",
    description: `இனியன் மற்றும் மகிழினி கல்லூரியில் இருந்து ஒருவரை ஒருவர் விரும்புகிறார்கள். விதி வசத்தால் இருவரும் பிரிந்து விடுகின்றனர்.இனியன் மாயா என்னும் பொண்ணை திருமணம் செய்து கொள்கிறான் . இனியன் ஒரு பெண் குழந்தைக்கு அப்பாவாக தனியாக வாழ்கிறான். அவனுடைய மனைவிக்கு என்னவாகியது ? அவன் ஏன் தனியாக குழந்தையோடு வாழ்கிறான். இனியன் வேண்டாம் என்று பிரிந்த சென்ற மகிழினி வேறு திருமணம் செய்து கொண்டாளா? இனியன் அவன் மனைவியுடன் மீண்டும் குழந்தைக்காக சேர்ந்து வாழ்வானா? இல்லை கல்லூரியில் காதலித்த மகிழினியுடன் மீண்டும் சேர்வானா?
    காத்திருந்த கல்லூரிக் காதல் மீண்டும் கை கூடுமா? என்று இந்த நாவலில் பார்க்கலாம்`,
    count: 60,
    price: 100,
    category: "Books",
    sales: 55,
  ...
  {
    name: "யானும் நீயும் எவ்வழியறிதும்..!! (முதல் பாகம்)",
    description: `பல கனவுகளோடும் ஆசைகளோடும் தன் வாழ்க்கையை திட்டமிட்டு நகர்த்திக் கொண்டு இருக்கும் நம் கதாநாயகியின் வாழ்வில் திடீரென திருமணம் குறுக்கிட.. அதன் பின் அவள் கனவுகளை நோக்கி தன் பயணத்தை தொடர்ந்தாளா..? அதற்கு அவளின் புகுந்த வீட்டினர் ஒத்துழைத்தார்களா..? நம் நாயகனின் நிலைப்பாடு எத்தகையது என்பதை எல்லாம் வழக்கமான குடும்ப அரசியல் கொஞ்சம் காதல் கொஞ்சம் மோதலோடு இந்த கதையில் காணலாம்..`,
    count: 60,
    price: 237,
    category: "Books",
    sales: 55,
  ...
  {
    name: "முள்ளோடு முத்தாடிய கள்வனே (Tamil Edition)",
    description: `அப்பன் பேச்ச கேட்டுகிட்டு, முத்துகுமரன் குடும்பத்த “கண்ணம் வச்சி கருவறுத்துட்டான்” அந்த வைரவேல்பாண்டியன்…. அந்தபுள்ள தங்கம் “முழுகாம இருக்குனு தெரிஞ்சும்”… அவனுக்கு “வேற பொண்ணு பாத்து பேசி முடிஞ்சிட்டானாம்”, அந்த வீரவேல் பாண்டியன்….

    இதெல்லாம் அநியாயமா இல்ல?..… நியாயம் கேக்க வேண்டியவங்களே.. அமைதியா இருக்காங்க… நமக்கு என்ன?.... இப்ப அந்தபுள்ள தங்கத்துக்கு… எத்தன மாசம்?.. அது இருக்கும் ஏழோ, எட்டோ.. இவனுங்க காசு, பணம், அந்தஸ்து, கவுரவம்னு பேசி… வீம்பு புடிச்சிகிட்டு திரியறானுங்க.. இதுல தேவையில்லாம, அந்தபுள்ள தங்கத்தோட வாழ்க்கைய வேற வீணாக்கிட்டானுங்க…`,
    count: 60,
    price: 250,
    category: "Books",
    sales: 55,
  ...
  },
  {
    ...
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/book1.jpg" }],
    attrs: [
  ...
  {
    name: "Doctor Strange Vol. 1: The Way of the Weird (Doctor Strange (2015-2018))",
    ...
    category: "Books",
    sales: 55,
    images: [{ path: "/images/products/books/book2.jpg" }],
    attrs: [
      { key: "Author", value: "Darko Macan" },
      { key: "Format", value: "Kindle Edition" },
      { key: "English and Indian Languages", value: "English" },
